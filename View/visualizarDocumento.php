    ...
    <div class="container m-auto bg-white rounded shadow p-4 border">
        <form action="../Controller/Navegacao.php" method="POST" class="row g-3 justify-content-between" id="documento">
            ...
            <div class="col-3 my-3">
                ...
                <input type="date" class="form-control" id="txtData" name="txtData" readonly value="<?php echo $_GET['data_de_cadastro']?>">
            </div>
            <div class="col-6 my-3">
                <label for="txtPossuidor" class="form-label">Possuidor</label>
                <input type="text" class="form-control" id="txtPossuidor" name="txtPossuidor" readonly value="<?php echo $_GET['nome_possuidor']?>">
            </div>
            <div class="col-3 my-3">
            ...
            <div class="col-8 my-3">
                ...
                <input class="form-control" id="txtDestinatario" name="txtDestinatario" readonly value="<?php echo $_GET['nome_destinatario']?>">
            </div>
